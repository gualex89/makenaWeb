	...
	<body class="home_motorcycle">
        ...
        <script>
            var canvas = new fabric.Canvas('canvas', {
                selection: true, // Permitir la selección de objetos
                passive: true
            });
            ...
            document.getElementById('imageLoader').addEventListener('change', function (e) {
                ...
                if (file.size > 3 * 1024 * 1024) { // Limitar tamaño a 3MB
                ...
                reader.onload = function (e) {
                    fabric.Image.fromURL(e.target.result, function (img) {
                        ...
                        img.on('mousedown', function () {
                            canvas.setActiveObject(img);
                            document.getElementById('gesture-layer').style.pointerEvents = 'auto'; // Habilitar gesture-layer si es imagen
                        });
                ...
                // Mover imagen de fondo al fondo
                canvas.sendToBack(fondoImg);
                canvas.renderAll();
        
                // Mostrar botones y controles relacionados
                $('#cambiarOrden').show();
                $('#btnEliminar').show();
            ...
            // Eventos táctiles para manejar el pellizco y arrastre en dispositivos móviles
            document.getElementById('gesture-layer').addEventListener('touchstart', function (e) {
                ...
                if (activeObject && activeObject.type === 'image' && e.touches.length === 2) {
                    ...
                    document.getElementById('gesture-layer').style.pointerEvents = 'none'; // Desactivar gesture-layer si no es imagen
                }
            });
            ...
            function agregarTexto() {
                ...
                texto.on('mousedown', function () {
                    canvas.setActiveObject(texto);
                    document.getElementById('gesture-layer').style.pointerEvents = 'none'; // Desactiva gesture-layer si es texto
                });
            }
            ...
            function cambiarTamanoImagen(delta) {
                ...
                if (obj && obj.type === 'image') {
                    obj.scaleX = obj.scaleX + delta;
                    obj.scaleY = obj.scaleY + delta;
                    canvas.renderAll();
                }
            }
            ...
            function rotarImagen(grados) {
                var obj = canvas.getActiveObject();
                if (obj && obj.type === 'image') {
                    obj.set('angle', grados);
                    canvas.renderAll();
                }
            }
        
            // Función para manejar la visibilidad del gesture-layer según el ancho de pantalla
            ...
            // Eventos para ajustar el gesture-layer en la carga y al redimensionar la ventana
