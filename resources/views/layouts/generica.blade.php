...
<body class="home_motorcycle">
  ...
  ================================================== -->
            ...
            <div class="sidebar_mobile_menu">
                ...
                <div class="msb_widget mobile_menu_list clearfix">
                    ...
                    <ul class="ul_li_block clearfix">
                        ...
                        <li>
                            <a href="#!" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Crea
                                tu Funda</a>
                        </li>
                    </ul>
                </div>
   ...
   ================================================== -->
        <section
            class="breadcrumb_section motorcycle_breadcrumb has_overlay text-white text-center d-flex align-items-end clearfix"
                            ...
                            <div class="sb_widget sb_recent_post">
                                ...
                                <div class="carparts_small_blog">
                                    ...
                                    <div class="item_content">
                                        ...
                                        <div class="item_price"><strong data-text-color="#39b54a">$9.900</strong>
                                            <del>$11.000</del></div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                        <div class="footer_widget footer_about text-center">
                            <div class="brand_logo mb_30">
                                <a href="#!">
                                    <img src="images/logo/logoMakena.png" srcset="images/logo/logo_22_2x.png 2x"
                                        alt="logo_not_found">
                                </a>
                            </div>
