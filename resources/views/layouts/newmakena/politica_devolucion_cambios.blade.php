                ...
                <div class="col-lg-10 col-md-12">
                    ...
                    <div class="faq-content " style="color:#333; ">
                        <p class="mb-4 text-justify" style="font-size:1.9rem; line-height:1.7em;">En <b>MakenaStore</b> ,
                            cada <b>producto</b> (ya sea una funda o un cuadro metalizado) se elabora de forma
                            <b>personalizada y bajo pedido</b>, por lo que <b>no realizamos devoluciones ni cambios</b> una
                            vez confirmado el diseño, <b>excepto en casos de defectos de fabricación</b> que impidan su uso
                            o colocación correcta.
                        </p>

                        <h3 class="mb-3" style="color:#b321a6; font-weight:700;">No realizamos cambios ni devoluciones
                            por:</h3>

                        <div class="mt-3 frecuentes-listas">

                            <ul class="mt-2"
                                style="padding-left:30px; font-size:1.6rem; list-style-type:disc; line-height:1.8;">
                                <li style="margin-bottom:8px;"><b>Diferencias mínimas en el posicionamiento de la
                                        imagen</b>, ya que variaciones de milímetros son inevitables dentro del proceso de
                                    sublimación.</li>
                                <li style="margin-bottom:8px;"><b>Leves variaciones en los tonos de color</b>, que pueden
                                    depender de la iluminación de la foto o la calibración de la pantalla.</li>
                                <li style="margin-bottom:8px;"><b>Pequeños puntos o imperfecciones</b> propias del proceso
                                    de impresión, siempre que no afecten la estética general, la funcionalidad o la
                                    durabilidad del producto.</li>
                            </ul>
                        </div>
                        <h3 class="mb-3" style="color:#b321a6; font-weight:700;">Sí realizamos cambios o devoluciones si:
                        </h3>
                        ...
                        <div class="mt-3 frecuentes-listas">
                            ...
                            <ul class="mt-2"
                                style="padding-left:30px; font-size:1.6rem; list-style-type:disc; line-height:1.8;">
                                <li style="margin-bottom:8px;">El producto <b>llega roto o presenta fallas</b> que impidan
                                    su uso o colocación normal.</li>
                                <li style="margin-bottom:8px;">El <b>modelo, diseño o medida recibido no coincide</b> con el
                                    pedido realizado.</li>

                            </ul>
                        </div>

                        <p class="mb-4 mt-5 text-justify" style="font-size:1.9rem; line-height:1.7em;">En cualquiera de
                            estos casos, el cliente deberá <b>notificarnos dentro de las 48 horas</b> posteriores a la
                            recepción del pedido, enviando fotos del producto a través de nuestros canales oficiales
                            (Instagram o WhatsApp). <br>
                        ...
                        <p class="mb-4 mt-5 text-justify" style="font-size:1.9rem; line-height:1.7em;">En <b>MakenaStore</b>
                            nos esforzamos para que cada producto llegue en perfectas condiciones y que el resultado final
                            <b>refleje exactamente lo que imaginaste</b>. Si algo no sale como esperabas, estamos para
                            ayudarte a resolverlo.</b>
                        </p>
