...
<div id="create" class="tabcontent active px-5 mx-5 mt-5">
  <div class="wrapper-content-create">
    <div class="heading-section">
      ...
      <p>
        Nuestros cuadros están fabricados en <strong style="color: white">aluminio</strong> con un grosor de <strong style="color: white">1 mm</strong>,
        con acabado <strong style="color: white">brillante</strong> tipo espejo e <strong style="color: white">impresión 4K</strong>
      ...
      <div class="opciones-container mt-5">
        ...
        <div class="grupo">
          ...
          <div class="botones mt-3">
            <button type="button" class="btn-opcion" data-group="tamaño" data-value="Basic">Basic<br><small>20 x 30 cm</small></button>
            <button type="button" class="btn-opcion" data-group="tamaño" data-value="Standard">Standard<br><small>30 x 40 cm</small></button>
            <button type="button" class="btn-opcion" data-group="tamaño" data-value="Epic">Epic<br><small>40 x 60 cm</small></button>
          </div>
        </div>
        ...
        <div class="grupo">
          ...
          <div class="botones mt-3">
            <button type="button" class="btn-opcion" data-group="colgante" data-value="Hook">Hook<br><small>Colgante clásico con tornillo</small></button>
            <button type="button" class="btn-opcion" data-group="colgante" data-value="Imán">Imán<br><small>Colgante con imán autoadhesivo</small></button>
          </div>
        </div>
  ...
  <button id="btnAgregarCarrito" class="tf-button style-1 h50 w216">
