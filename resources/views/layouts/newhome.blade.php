                    ...
                    <div class="row">
                        <div class="col-12 pages-title">
                            ...
                            <div class="icon-background">
                                ...
                                <img class="absolute item3" src="{{ asset('assets_new/images/item-background/item3.png') }}" alt="">
                                ...
                                <img class="absolute item6" src="{{ asset('assets_new/images/item-background/item4.png') }}" alt="">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="tf-card-box">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('assets_new/images/box-item/banner-01.jpg') }} " alt="">
                                                    </a>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('assets_new/images/box-item/banner-02.jpg') }}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('assets_new/images/box-item/banner-03.jpg') }}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('assets_new/images/box-item/banner-04.jpg') }}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('assets_new/images/box-item/banner-05.jpg') }}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('assets_new/images/box-item/banner-06.jpg') }}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('assets_new/images/box-item/banner-07.jpg') }}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                            ...
                            <div class="swiper-container seller seller-slider2" data-swiper='{
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tf-author-box text-center">
                                            <div class="author-avatar ">
                                                <img src="{{ asset('assets_new/images/avatar/avatar-01.png') }}" alt="" class="avatar">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-author-box text-center">
                                            <div class="author-avatar ">
                                                <img src="{{ asset('assets_new/images/avatar/avatar-02.png') }}" alt="" class="avatar">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-author-box text-center">
                                            <div class="author-avatar ">
                                                <img src="{{ asset('assets_new/images/avatar/avatar-03.png') }}" alt="" class="avatar">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-author-box text-center">
                                            <div class="author-avatar ">
                                                <img src="{{ asset('assets_new/images/avatar/avatar-04.png') }}" alt="" class="avatar">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-author-box text-center">
                                            <div class="author-avatar ">
                                                <img src="{{ asset('assets_new/images/avatar/avatar-05.png') }}" alt="" class="avatar">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-author-box text-center">
                                            <div class="author-avatar ">
                                                <img src="{{ asset('assets_new/images/avatar/avatar-06.png') }}" alt="" class="avatar">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="image">
                            <img src="{{ asset('assets_new/images/backgroup-section/popup.png') }}" alt="">
                        </div>
                        <div class="logo-rotate">
                            <img class="" src="{{ asset('assets_new/images/item-background/item6-img.png') }}" alt="">
                        </div>
