<footer class="footer_section motorcycle_footer clearfix">
    <div class="footer_widget_area sec_ptb_60 clearfix" data-bg-color="#111111"> 
        <div class="container">
            <div class="row justify-content-lg-between">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 widget-menu">
                    <div class="footer_widget text_footer footer_about">
                        <ul>
