...
<body>
    ...
    <h3>Si seleccionaste <span style="font-weight: bold; color: #f831fe">RETIRO</span> o envio por <span style="font-weight: bold; color: #f831fe">MOTOMENSAJERÍA</span>  <br>
        -Recibirás un mail cuando tu pedido esté listo para retirar o ser enviado.
    </h3>

    <h3>
        Si tu envio es por <span style="font-weight: bold; color: #f831fe">CORREO</span> <br>
